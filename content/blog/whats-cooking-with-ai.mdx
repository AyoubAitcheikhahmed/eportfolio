...
description: "How we built a Chrome extension that turns your online shopping basket into a recipe, using AI, AWS and Terraform."
date: "2024-03-25"
tags: ["AI", "aws", "internship", "springAI", "terraform", "docker"]
draft: false
cover: "/images/whatscooking/whatscooking-banner.jpg"
---

*Written together with Jonathan Moermans and Febe Cap.*
...
![Chrome extension recipe flow](/images/whatscooking/whatscooking-chrome-recipe.png)
...
For this we implemented a custom prompting technique based on [Few-Shot Prompting](https://www.promptingguide.ai/techniques/fewshot).
...
![Application Architecture Diagram](/images/whatscooking/ArchitectureDiagramBlog.jpg)
